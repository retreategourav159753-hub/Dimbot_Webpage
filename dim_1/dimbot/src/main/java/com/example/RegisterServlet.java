...
public class RegisterServlet extends HttpServlet {
    public static final String URL = "jdbc:mysql://mysql-8cecaef-project-b430.f.aivencloud.com:26892/defaultdb?sslmode=require";
    public static final String USER = "avnadmin";
    public static final String PASSWORD = "AVNS_qqSDBsQRUrSeCZKx8wu";
