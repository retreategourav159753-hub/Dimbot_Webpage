...
<body>
    ...
    <header class="header-main sticky">
        ...
        <nav class="nav_bar">
            <ul>
                ...
                <li><a href="#Courses" class="header_links">Dashboard</a></li>
                <li><a href="#ContactUs" class="header_links">ContactUs</a></li>
            </ul>
        </nav>

        <div class="search_bar">
            <input type="text" placeholder="Search what you want to learn..." class="search_input">
    ...
    <div style="margin-top: 200px;">
        ...
        <button class="dashboard_button" href="Login.jsp" target="_blank">Login</button>
    </div>
    <% } %>
