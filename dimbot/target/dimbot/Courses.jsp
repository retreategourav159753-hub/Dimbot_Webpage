    ...
    <header class="header-main sticky">
        ...
        <nav class="nav_bar">
            <ul>
                ...
                <li><a href="#Dashboard" class="header_links">Dashboard</a></li>
                <% }else { %>
    ...
    <Section class="third-wave">
        ...
        <a href="TrackLinkServlet?url=https://www.w3schools.com/mongodb/index.php" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
                        <img src="https://icon.icepanel.io/Technology/svg/MongoDB.svg	https://icon.icepanel.io/Technology/svg/MongoDB.svg" alt="" class="lang-logo">
