...
<body>
    ...
    <Section class="second-wave">
        ...
        <a href="TrackLinkServlet?url=https://www.w3schools.com/html/default.asp&course=HTML" target="_blank">
            <div class="flip-card">
        ...
        <a href="TrackLinkServlet?url=https://www.w3schools.com/css/default.asp&course=CSS" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
        ...
        <a href="TrackLinkServlet?url=https://www.geeksforgeeks.org/javascript/javascript-tutorial/&course=JavaScript" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
        ...
        <a href="TrackLinkServlet?url=https://www.w3schools.com/typescript/&course=TypeScript" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
    ...
    <Section class="third-wave">
        ...
        <a href="TrackLinkServlet?url=https://www.w3schools.com/python/default.asp&course=Python" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
        ...
        <a href="TrackLinkServlet?url=https://www.geeksforgeeks.org/java/learn-java-for-android-app-development-a-complete-guide/&course=Java" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
        ...
        <a href="TrackLinkServlet?url=https://www.w3schools.com/php/&course=PHP" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
        ...
        <a href="TrackLinkServlet?url=https://www.w3schools.com/react/default.asp&course=React" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
        ...
        <a href="TrackLinkServlet?url=https://www.w3schools.com/cs/index.php&course=C#" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
    ...
    <Section class="third-wave">
        ...
        <a href="TrackLinkServlet?url=https://www.w3schools.com/mysql/default.asp&course=MySQL" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
        ...
        <a href="TrackLinkServlet?url=https://www.w3schools.com/postgresql/index.php&course=PostgreSQL" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
        ...
        <a href="TrackLinkServlet?url=https://www.w3schools.com/mongodb/index.php&course=MongoDB" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
    ...
    <Section class="third-wave">
        ...
        <a href="TrackLinkServlet?url=https://www.geeksforgeeks.org/android/a-complete-guide-to-learn-xml-for-android-app-development/&course=XML" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
        ...
        <a href="TrackLinkServlet?url=https://www.geeksforgeeks.org/kotlin/kotlin-android-tutorial/&course=Kotlin" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
        ...
        <a href="TrackLinkServlet?url=https://reactnative.dev/&course=React Native" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
        ...
        <a href="TrackLinkServlet?url=https://roadmap.sh/java&course=App Development" target="_blank">
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
