...
<body>
    <div class="wrapper">
        <form action="LoginServlet" method="POST">
            ...
            <p>Back to : <a href="welcome.html" style="text-decoration: none; color: skyblue;">Home</a>  or  <a href="Register.html" style="text-decoration: none; color: skyblue;">Register</a></p>
        </form>
    </div>
</body>
</html>