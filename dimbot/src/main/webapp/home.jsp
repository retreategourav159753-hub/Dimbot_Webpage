...
<body>
    ...
    <section class="first-wave">
        <div class="welcome">
            ...
            <p class="about_us">Your one-stop destination for learning and growth. Explore our wide range of courses,
                connect with experts, and unlock your potential. Sign up today and embark on a journey of knowledge and
                success!</p>
        </div>
    </section>
